...
//<-
    detail::copy_cv_ref<
        ...
        detail::sfinae_try<
            typename detail::traits<detail::shallow_decay_except_func_ref<T>>::add_member_const,

            detail::fail_when_same<typename detail::traits<detail::shallow_decay_except_func_ref<T>>::add_member_const,
                detail::abominable_functions_not_supported_on_this_compiler,
                this_compiler_doesnt_support_abominable_function_types>,

            detail::fail_if_invalid<typename detail::traits<detail::shallow_decay_except_func_ref<T>>::add_member_const,
