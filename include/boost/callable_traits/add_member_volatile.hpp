...
//<-
    detail::copy_cv_ref<
        ...
        detail::sfinae_try<
            typename detail::traits<detail::shallow_decay_except_func_ref<T>>::add_member_volatile,

            detail::fail_when_same<typename detail::traits<detail::shallow_decay_except_func_ref<T>>::add_member_volatile,
